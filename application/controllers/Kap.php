...
class Kap extends CI_Controller
{
    ...
    public function tabel_kap_dapatDigunakan()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->KapModel->GetKap('WHERE jatuhTempoKap LIKE "%' . $_POST['periode'] . '%" AND dateDeletePerusahaanKap = "0000-00-00"  AND id_statusPerusahaan = "1" ')->result();
            foreach ($get1 as $g1) {
    ...
    public function tabel_kap_tidakDapatDigunakan()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->KapModel->GetKap('WHERE jatuhTempoKap LIKE "%' . $_POST['periode'] . '%" AND dateDeletePerusahaanKap = "0000-00-00"  AND id_statusPerusahaan = "2" ')->result();
            foreach ($get1 as $g1) {
    ...
    public function tabel_kap_terbatas()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->KapModel->GetKap('WHERE jatuhTempoKap LIKE "%' . $_POST['periode'] . '%" AND dateDeletePerusahaanKap = "0000-00-00"  AND id_statusPerusahaan = "4" ')->result();
            foreach ($get1 as $g1) {
            ...
            foreach ($get1 as $g1) {
                $id_perusahaan = $g1->id_perusahaanKap;
                $where2 = "WHERE id = " . $id_perusahaan . " AND jatuhTempoKap LIKE '%" . $_POST['periode'] . "%' AND dateDeletePerusahaanKap = '0000-00-00' AND id_statusPerusahaan = '4' ";
                $get2 = $this->KapModel->GetKap($where2)->result();
