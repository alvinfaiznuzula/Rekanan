...
class Asuransi_Jiwa extends CI_Controller
{
    ...
    public function tabel_aj_perusahaan()
    {
        ...
        if (isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->AjModel->getAj('WHERE jatuhTempo LIKE "%' . $_POST['periode'] . '%" AND dateDeleteAj = "0000-00-00" AND id_status <> 3 ')->result();
            foreach ($get1 as $g1) {
    ...
    public function tabel_aj_dapatDigunakan()
    {
        ...
        if (isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->AjModel->getAj('WHERE jatuhTempo LIKE "%' . $_POST['periode'] . '%" AND dateDeleteAj = "0000-00-00" AND id_status = "1" ')->result();
            foreach ($get1 as $g1) {
    ...
    public function tabel_aj_tidakDapatDigunakan()
    {
        ...
        if (isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->AjModel->getAj('WHERE jatuhtempo LIKE "%' . $_POST['periode'] . '%" AND dateDeleteAj = "0000-00-00" AND id_status = "2" ')->result();
            foreach ($get1 as $g1) {
    ...
    public function tabel_aj_terbatas()
    {
        ...
        if (isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->AjModel->getAj('WHERE jatuhTempo LIKE "%' . $_POST['periode'] . '%" AND dateDeleteAj = "0000-00-00" AND id_status = 4 ')->result();
            foreach ($get1 as $g1) {
