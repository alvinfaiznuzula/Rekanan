...
class Bls extends CI_Controller
{
    ...
    public function tabel_bls_perusahaan()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->BlsModel->GetBls('WHERE jatuhTempo LIKE "%' . $_POST['periode'] . '%" AND dateDeleteBLS = "0000-00-00" AND id_status <> 3')->result();
            foreach ($get1 as $g1) {
    ...
    public function tabel_bls_dapatDigunakan()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->BlsModel->GetBls('WHERE jatuhTempo LIKE "%' . $_POST['periode'] . '%" AND dateDeleteBLS = "0000-00-00" AND id_status= "1" ')->result();
            foreach ($get1 as $g1) {
                $id_status = $g1->id_status;
                $check6 = $this->BlsModel->GetStatus("WHERE id = " . $id_status)->result();
                foreach ($check6 as $c6) {
    ...
    public function tabel_bls_tidakDapatDigunakan()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->BlsModel->GetBls('WHERE jatuhTempo LIKE "%' . $_POST['periode'] . '%" AND dateDeleteBLS = "0000-00-00" AND id_status= "2" ')->result();
            foreach ($get1 as $g1) {
                $id_status = $g1->id_status;
                $check6 = $this->BlsModel->GetStatus("WHERE id = " . $id_status)->result();
                foreach ($check6 as $c6) {
    ...
    public function tabel_bls_terbatas()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            foreach ($get1 as $g1) {
                $id_perusahaan = $g1->id_perusahaanBLS;
                $where2 = "WHERE id = " . $id_perusahaan . " AND jatuhTempo LIKE '%" . $_POST['periode'] . "%' AND dateDeleteBLS = '0000-00-00' AND id_status= '4' ";
                $get2 = $this->BlsModel->GetBls($where2)->result();
