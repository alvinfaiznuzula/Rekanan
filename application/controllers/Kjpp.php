...
class Kjpp extends CI_Controller
{
    ...
    public function tabel_kjpp_perusahaan()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            foreach ($get1 as $g1) {
                $id_perusahaan = $g1->id_perusahanKjpp;
                $where2 = "WHERE id = " . $id_perusahaan . " AND djatuhTempoKjpp LIKE '%" . $_POST['periode'] . "%' AND dateDeleteKjpp = '0000-00-00' AND id_status <> 3 ";
                $get2 = $this->KjppModel->GetKjpp($where2)->result();
    ...
    public function tabel_kjpp_dapatDigunakan()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->KjppModel->GetKjpp('WHERE jatuhTempoKjpp LIKE "%' . $_POST['periode'] . '%" AND dateDeleteKjpp = "0000-00-00" AND id_status = "1" ')->result();
            foreach ($get1 as $g1) {
                $id_status = $g1->id_status;
                $check6 = $this->KjppModel->GetStatus("WHERE id = " . $id_status)->result();
                foreach ($check6 as $c6) {
            ...
            foreach ($get1 as $g1) {
                $id_perusahaan = $g1->id_perusahanKjpp;
                $where2 = "WHERE id = " . $id_perusahaan . " AND jatuhTempoKjpp LIKE '%" . $_POST['periode'] . "%' AND dateDeleteKjpp = '0000-00-00' AND id_status = '1' ";
                $get2 = $this->KjppModel->GetKjpp($where2)->result();
    ...
    public function tabel_kjpp_tidakDapatDigunakan()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->KjppModel->GetKjpp('WHERE jatuhTempoKjpp LIKE "%' . $_POST['periode'] . '%" AND dateDeleteKjpp = "0000-00-00" AND id_status = "2" ')->result();
            foreach ($get1 as $g1) {
                $id_status = $g1->id_status;
                $check6 = $this->KjppModel->GetStatus("WHERE id = " . $id_status)->result();
                foreach ($check6 as $c6) {
            ...
            foreach ($get1 as $g1) {
                $id_perusahaan = $g1->id_perusahanKjpp;
                $where2 = "WHERE id = " . $id_perusahaan . " AND jatuhTempoKjpp LIKE '%" . $_POST['periode'] . "%' AND dateDeleteKjpp = '0000-00-00' AND id_status = '2' ";
                $get2 = $this->KjppModel->GetKjpp($where2)->result();
    ...
    public function tabel_kjpp_terbatas()
    {
        ...
        if (isset($_POST['id_kota']) && !isset($_POST['periode'])) {
            ...
            $where1 = "";
            $get1 = $this->KjppModel->GetKjpp('WHERE jatuhTempoKjpp LIKE "%' . $_POST['periode'] . '%" AND dateDeleteKjpp = "0000-00-00" AND id_status = "4" ')->result();
            foreach ($get1 as $g1) {
                $id_status = $g1->id_status;
                $check6 = $this->KjppModel->GetStatus("WHERE id = " . $id_status)->result();
                foreach ($check6 as $c6) {
            ...
            foreach ($get1 as $g1) {
                $id_perusahaan = $g1->id_perusahanKjpp;
                $where2 = "WHERE id = " . $id_perusahaan . " AND jatuhTempoKjpp LIKE '%" . $_POST['periode'] . "%' AND dateDeleteKjpp = '0000-00-00' AND id_status = '4' ";
                $get2 = $this->KjppModel->GetKjpp($where2)->result();
